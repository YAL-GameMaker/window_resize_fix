...
set extName=window_resize_fix
set dllName=window_resize_fix
set gmlDir14=%solutionDir%window_resize_fix.gmx
set gmlDir22=%solutionDir%window_resize_fix_yy
set gmlDir23=%solutionDir%window_resize_fix_23
